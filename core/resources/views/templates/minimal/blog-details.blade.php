...
<body>
            ...
            <ul class="nav">
              <li class="nav-item dropdown ml-lg-2">
                ...
                <div class="dropdown-menu dropdown-menu-sm">
                  <a href="#" class="dropdown-item"><img alt="Image placeholder" src="{{asset('assets_new/s/img/icons/flags/es.svg')}}">Spanish</a>
    ...
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light bg-white" id="navbar-main">
      <div class="container px-lg-0">
        ...
        <a class="navbar-brand mr-lg-5" href="../../index.html">
          <img alt="Image placeholder" src="{{asset('assets_new//img/brand/dark.png') }}" id="navbar-logo" style="height: 50px;">
        </a>
  ...
  <div class="main-content">
            ...
            <div class="media align-items-center mt-5">
              <div>
                <a href="#" class="avatar rounded-circle mr-3">
                  <img alt="Image placeholder" src="{{asset('assets_new/img/theme/light/team-6-800x800.jpg') }}">
                </a>
              </div>
    ...
    <section class="bg-cover bg-size--cover" style="height: 600px; background-image:url({{asset('assets_new/img/backgrounds/img-1-1920x800.jpg') }});
      background-position: top center;"></section>
    <section class="slice">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-9">
            ...
            <article>
              ...
              <figure class="figure">
                <img alt="Image placeholder" src="{{asset('assets_new/img/theme/light/img-3-800x600.jpg') }}" class="img-fluid rounded">
                <figcaption class="mt-3 text-muted">Figure one: Type here your description</figcaption>
              </figure>
              <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
              <h5>Second thing you need to do</h5>
              <figure class="figure">
                <img alt="Image placeholder" src="{{asset('assets_new/img/theme/light/img-4-800x600.jpg') }}" class="img-fluid rounded">
            ...
            <div class="mb-3">
              <div class="media media-comment">
                <img alt="Image placeholder" class="rounded-circle shadow mr-4" src="{{asset('assets_new/img/theme/light/team-2-800x800.jpg')}}" style="width: 64px;">
                <div class="media-body">
              ...
              <div class="media media-comment">
                <img alt="Image placeholder" class="rounded-circle shadow mr-4" src="{{asset('assets_new/img/theme/light/team-3-800x800.jpg') }}" style="width: 64px;">
                <div class="media-body">
                  <div class="media-comment-bubble left-top">
              ...
              <div class="media media-comment align-items-center">
                <img alt="Image placeholder" class="avatar rounded-circle shadow mr-4" src="{{asset('assets_new/img/theme/light/team-1-800x800.jpg') }}">
                <div class="media-body">
                  <form>
      ...
      <div class="container">
        <div class="row pt-md">
          <div class="col-lg-4 mb-5 mb-lg-0">
            <a href="../../index.html">
              <img src="{{asset('assets_new/img/brand/white.png') }}" alt="Footer logo" style="height: 70px;">
            </a>
  ...
  <!-- Page JS -->
  <script src="{{asset('assets_new/libs/autosize/dist/autosize.min.js') }}"></script>
  <!-- Purpose JS -->
